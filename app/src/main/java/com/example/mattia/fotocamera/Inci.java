...
public class Inci {
    ...
    /**
     * @author Giovanni Fasan(g1)
     * @return String with listIngredientFound
     */
    public String listIngredientsToString(){
        String s="";

        for (int i=0; i<listIngredientFound.size(); i++){
            s=s + "<b>" + listIngredientFound.get(i) + "</b>; ";
        }
     ...
     * adds the ingredients inci that were found in the text within the array
     */
